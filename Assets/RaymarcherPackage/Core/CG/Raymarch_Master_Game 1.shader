Shader "Matej Vanco/RayMarcher/Mobile/RM Master_Game 1"
{
	...
	{	
		...
		Pass
		{
			CGPROGRAM
				...
				#include "ShapeSources\Raymarch_ShapesSource_Game 1.cginc"

				#include "Includes\Mobile\Raymarch_FractsSource.cginc"

				#include "ObjectBuffers\Raymarch_ObjectBuffer_Game 1.cginc"	
