Shader "Matej Vanco/RayMarcher/PC/RM Master_Game"
{
	...
	SubShader
	{
		...
		Pass
		{
			CGPROGRAM
				...
				#include "ShapeSources\Raymarch_ShapesSource_Game.cginc"

				#include "Includes\PC\Raymarch_FractsSource.cginc"

				#include "ObjectBuffers\Raymarch_ObjectBuffer_Game.cginc"	
